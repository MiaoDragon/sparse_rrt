...
public:
	...
	void step_bvp(system_interface* propagate_system, psopt_system_t* bvp_system, psopt_result_t& res, double* start_state, double* goal_state, int num_iters, int num_steps, double step_sz,
