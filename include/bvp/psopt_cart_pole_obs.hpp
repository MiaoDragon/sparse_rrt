...
#ifndef PSOPT_CARTPOLE_OBS_HPP
#define PSOPT_CARTPOLE_OBS_HPP
...
class psopt_cart_pole_obs_t : public psopt_system_t
{
public:
	psopt_cart_pole_obs_t(std::vector<std::vector<double>>& _obs_list, double width)
        : psopt_system_t()
	{
		state_dimension = 4;
		control_dimension = 1;
