...
public:
    /** \brief Constructor */
    MPNetSMP(planner_t& planner, std::string mlp_path, std::string encoder_path,
    ...
    void plan(at::Tensor obs, std::vector<double> start_state, std::vector<double> goal_state, int max_iteration);
    ~MPNetSMP();
