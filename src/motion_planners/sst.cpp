...
void sst_t::step_bvp(const system_interface* propagate_system, const psopt_system_t* bvp_system, psopt_result_t& step_res, const double* start_state, const double* goal_state, int num_iters, int num_steps, double step_sz,
