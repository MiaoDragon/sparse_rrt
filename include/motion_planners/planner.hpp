...
public:
	 ...
	 */
	virtual void step_with_sample(system_interface* system, double* sample_state, double* new_state, double* new_control, double& new_time, int min_time_steps, int max_time_steps, double integration_step) = 0;
